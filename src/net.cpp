...
static const char *strMainNetDNSSeed[][2] = {
    {"node.cryptometh.com", "node.cryptometh.com"},
	{"node.cryptometh.net", "node.cryptometh.net"},
	{"cryptometh.com", "cryptometh.com"},
	{"node2.cryptometh.net", "node2.cryptometh.net"},
	{"node2.cryptometh.com", "node2.cryptometh.com"},
	{"node3.cryptometh.net", "node3.cryptometh.net"},
	{"node3.cryptometh.com", "node3.cryptometh.com"},
	{"89.70.228.120", "89.70.228.120"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CryptoMETH is probably already running."), addrBind.ToString().c_str());
        else
