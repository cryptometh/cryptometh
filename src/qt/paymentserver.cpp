...
const QString BITCOIN_IPC_PREFIX("cryptometh:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click cryptometh: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start cryptometh: click-to-pay handler");
    else
...
{
    // clicking on cryptometh: URLs creates FileOpen events on the Mac:
